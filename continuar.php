...
<title>Continuar Con el Pedido</title>
</head>
<body>
...
<div class="center mt-5">
    <div class="card pt-3" >
            <p style="font-weight: bold; color: #0F6BB7; font-size: 22px;">Pedido</p>
...
<a type="button" class="btn btn-success my-4" href="siguiente.php">Continuar pedido</a>
</div>
</div>
<!-- END vista B -->
